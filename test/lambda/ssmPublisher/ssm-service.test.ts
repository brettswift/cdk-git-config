...
import { SsmGateway } from '../../../lib/lambdas/ssmPublisher/ssm-param-gateway';
import { SsmService } from '../../../lib/lambdas/ssmPublisher/ssm-service';

jest.mock('../../../lib/lambdas/ssmPublisher/ssm-param-gateway.ts')
...
describe('SsmService Test', () => {
    ...
    test('should detect key in config group', async () => {
        ...
        const existingKeyResult = ssmService.configGroupContainsKey(configGroups, param1.Name)
        const newKeyResult = ssmService.configGroupContainsKey(configGroups, 'newKey')
